...
class CustomDialog extends StatefulWidget {
  ...
  CustomDialog({this.user, this.buttonText = 'Ekle', this.processType});
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: FlatButton(
                    onPressed: () {
                      if (widget.processType == ProcessType.INSERT) {
                        Provider.of<UserProcess>(context, listen: false)
                            .insertProcess(
                                context, widget.user, 'Kayıt Eklendi');
                      }
                      else if(widget.processType == ProcessType.UPDATE)
                      {
                          Provider.of<UserProcess>(context, listen: false)
                            .updateProcess(
                                context, widget.user, 'Kayıt Güncellendi');
                      }
                    },
                    child: Text(
                      widget.buttonText,
